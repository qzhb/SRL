...
def get_scores_fusion(args, models, loaders):
    verb_scores = 0
    noun_scores = 0
    action_scores = 0
...
def fusion_validation(args, model, loader):
    verb_scores, noun_scores, action_scores, verb_labels, noun_labels, action_labels = get_scores_fusion(args, model, loader)
